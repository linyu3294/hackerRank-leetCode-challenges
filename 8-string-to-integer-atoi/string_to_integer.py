...
3. Read this character in if it is either.
4. This determines if the final result is negative or positive respectively. Assume the result is positive if neither is present.
...
6. Convert these digits into an integer (i.e. "123" -> 123, "0032" -> 32).
